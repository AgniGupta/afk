...
class AFKMod(loader.Module):
    ...
    strings = {
        "name": "AFK",
        "gone": "<b>Извините, но хозяин не в сети! 🥺</b>",
        "back": "<b>Мой милый хозяин вернулся! 😊</b>",
        "afk": "<b>Моего хозяина уже нет {}.\nОн не разрешает общаться с незнакомыми! 🥺</b>",
        "afk_reason": "<b>Моего хозяина уже нет {}.\nОн не разрешает общаться с незнакомыми! 🥺 Но попросил обняв передать:</b> <i>{}</i>",
    }
